...
class Integration_Divi {
    ...
    public function init() {
        ...
        $this->name           = 'gs-testimonial-divi';
        $this->plugin_dir_url = GSTM_PLUGIN_URI . '/includes/integrations/assets/divi';

        add_action( 'et_builder_modules_loaded', 'GSTM\divi_widget_class' );
    ...
    public function editor_style() {
        ...
        <style>
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_testimonial_slider:before {
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_testimonial_slider {
                height: 67px;
            }
    ...
    public function wp_hook_enqueue_scripts() {
        ...
        if ( et_core_is_fb_enabled() ) {
            ...
            wp_enqueue_script( "{$this->name}-builder", $bundle_url, ['react-dom'], GSTM_VERSION, true );
...
function divi_widget_class() {
    ...
    class Divi_Widget extends \ET_Builder_Module {                
        ...
        public $slug       = 'gs_testimonial_slider';
        public $vb_support = 'on';
        
        public function init() {                    
            $this->name = 'Solid Testimonials';
        }
        ...
        public function get_fields() {
            ...
            return array(
                'shortcode'     => array(
                    'label'           => esc_html__( 'Select Shortcode', 'gs-testimonial' ),
                    'type'            => 'select',
                    'option_category' => 'basic_option',
                    'description'     => 'Show Testimonials by Solid Testimonials Plugin',
                ...
                '__shortcode' => array(
                    'type'                => 'computed',
                    'computed_callback'   => array( 'GSTM\Divi_Widget', 'get_shortcode' ),
        ...
        static function get_shortcode( $args ) {
            ...
            return do_shortcode( sprintf( '[gs_testimonial id="%s" /]', esc_attr($args['shortcode']) ) );
