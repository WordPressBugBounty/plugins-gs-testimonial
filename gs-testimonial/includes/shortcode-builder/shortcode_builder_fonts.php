...
class GSTM_SEC_Shortcode_Fonts {
	...
	public static function get_instance() {
        ...
        if ( is_null( self::$_instance ) ) {
            self::$_instance = new GSTM_SEC_Shortcode_Fonts();
        }
	...
	public static function get_font_groups() {
		...
		if ( null === self::$font_groups ) {
			...
			self::$font_groups = [
				self::SYSTEM => esc_html__( 'System', 'gs-testimonial' ),
				self::GOOGLE => esc_html__( 'Google', 'gs-testimonial' ),
				self::EARLYACCESS => esc_html__( 'Google Early Access', 'gs-testimonial' ),
			];
